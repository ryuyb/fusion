...
func (_c *NotificationChannelCreate) SetDeleteAt(v time.Time) *NotificationChannelCreate {
	_c.mutation.SetDeleteAt(v)
	return _c
}

// SetNillableDeleteAt sets the "delete_at" field if the given value is not nil.
func (_c *NotificationChannelCreate) SetNillableDeleteAt(v *time.Time) *NotificationChannelCreate {
	if v != nil {
		_c.SetDeleteAt(*v)
	}
	return _c
...
func (_c *NotificationChannelCreate) SetChannelType(v notificationchannel.ChannelType) *NotificationChannelCreate {
...
func (_c *NotificationChannelCreate) SetIsEnabled(v bool) *NotificationChannelCreate {
	_c.mutation.SetIsEnabled(v)
	return _c
}

// SetNillableIsEnabled sets the "is_enabled" field if the given value is not nil.
func (_c *NotificationChannelCreate) SetNillableIsEnabled(v *bool) *NotificationChannelCreate {
	if v != nil {
		_c.SetIsEnabled(*v)
	}
	return _c
...
func (_c *NotificationChannelCreate) defaults() error {
	if _, ok := _c.mutation.IsEnabled(); !ok {
		v := notificationchannel.DefaultIsEnabled
		_c.mutation.SetIsEnabled(v)
	}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if notificationchannel.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized notificationchannel.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if notificationchannel.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized notificationchannel.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
...
func (_c *NotificationChannelCreate) check() error {
	...
	if _, ok := _c.mutation.IsEnabled(); !ok {
		return &ValidationError{Name: "is_enabled", err: errors.New(`ent: missing required field "NotificationChannel.is_enabled"`)}
	}
	if _, ok := _c.mutation.Priority(); !ok {
