...
// RuleType values.
const (
	RuleTypeSilentPeriod  RuleType = "silent_period"
	RuleTypeRateLimit     RuleType = "rate_limit"
	RuleTypeContentFilter RuleType = "content_filter"
)
...
func RuleTypeValidator(rt RuleType) error {
	switch rt {
	case RuleTypeSilentPeriod, RuleTypeRateLimit, RuleTypeContentFilter:
		return nil
	default:
		return fmt.Errorf("notificationrule: invalid enum value for rule_type field: %q", rt)
	}
}
